...
namespace ExtUI {
  ...
  enum tramming   : uint8_t { T_full_turns_1, T_full_turns_2, T_full_turns_3, T_minutes_1, T_minutes_2, T_minutes_3, T_diff_1, T_diff_2, T_diff_3, T_ccw_1, T_ccw_2, T_ccw_3};
  ...
  // GST
  void onTrammingChanged(const char * const msg);
  void onTrammingChanged(FSTR_P const fstr);
  // GST
  void onHomingStart();
