...
#define _LANGUAGE_RU_H_
    ...
    #define RU_ABL                  "Стоп"
    #define RU_UBL                  "UBL"
    #define RU_UBL_START            "UBL Начало"
    #define RU_MBL                  "Man. выравнивание"
    #define RU_TRAMMING             "Tramming"
    ...
    #define RU_BLTOUCH_INIT         "перезагрузить"
    #define RU_BLTOUCH_REPEAT       "Точность Z"
    #define RU_PROBE_OFFSET         "Отступ Z"
    #define RU_EEPROM_LOAD          "нагрузка"
    ...
    #define RU_STATUS_FEEDBACK      "обратная связь:"
    ...
    #define RU_LABEL_START          "Начинать"
    #define RU_LABEL_SAVE           "сохранить"
    #define RU_LABEL_ABL_SETTINGS_UBL_SAVE  ""
    #define RU_LABEL_ABL_SETTINGS_UBL_LOAD  ""
    #define RU_LABEL_ABL_SLOT0      "Место 1"
    #define RU_LABEL_ABL_SLOT1      "Место 2"
    #define RU_LABEL_ABL_SLOT2      "Место 3"
    #define RU_LABEL_ABL_SLOT3      "Место 4"
    #define RU_LABEL_CONFIRMATION   "Подтверждать"
    #define RU_LABEL_CANCEL         "Прерывать"
    #define RU_LABEL_ABL_SLOT_EEPROM ""
    #define RU_LABEL_ABL_SETTINGS_UBL ""
#endif
