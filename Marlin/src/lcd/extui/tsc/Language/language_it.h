...
#define _LANGUAGE_IT_H_
    ...
    #define IT_PRINTING_COMPLETED   "Printing completed!"
    #define IT_STATUS_INFO          "Info"
    #define IT_STATUS_FEEDBACK      "Tramming-Feedback:"
    #define IT_ERROR                "Error"
    #define IT_TIPS                 "Tips"
    #define IT_EEPROM_SAVE_SUCCESS  "EEPROM parameters saved successfully"
    #define IT_EEPROM_SAVE_FAILED   "EEPROM parameters saved failed"
    #define IT_LABEL_START          "Inizio"
    #define IT_LABEL_SAVE           "Salva"
    #define IT_LABEL_ABL_SETTINGS_UBL_SAVE  ""
    #define IT_LABEL_ABL_SETTINGS_UBL_LOAD  ""
    #define IT_LABEL_ABL_SLOT0      "Luogo 1"
    #define IT_LABEL_ABL_SLOT1      "Luogo 2"
    #define IT_LABEL_ABL_SLOT2      "Luogo 3"
    #define IT_LABEL_ABL_SLOT3      "Luogo 4"
    #define IT_LABEL_CONFIRMATION   "Confermare"
    #define IT_LABEL_CANCEL         "Interrompere"
    #define IT_LABEL_ABL_SLOT_EEPROM ""
    #define IT_LABEL_ABL_SETTINGS_UBL ""
#endif
