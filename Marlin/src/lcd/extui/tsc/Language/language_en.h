...
#define _LANGUAGE_EN_H_
    ...
    #define EN_PRINTING_COMPLETED   "Printing completed!"
    #define EN_STATUS_INFO          "Info"
    #define EN_STATUS_FEEDBACK      "Tramming-Feedback:"
    ...
    #define EN_LABEL_ABL_SLOT_EEPROM ""
    #define EN_LABEL_ABL_SETTINGS_UBL ""
#endif
