...
public:
  ...
  static void clear_lcd();
    ...
    static constexpr uint8_t get_progress_percent() { return 0; }
      ...
      #endif
    #else
      #define MAX_MESSAGE_LENGTH 263 // GST
      #define MAX_TMESSAGE_LENGTH 1024
    #endif

    static char status_message[];
    static char tramming_message[];
...
// GST
  static void set_T_status(const char * const cstr, const bool persist=false);
  static void set_T_status(FSTR_P const fstr, const int8_t level=0);
// GST
...
private:
    ...
    static void finish_T_status(const bool persist);
  #endif
