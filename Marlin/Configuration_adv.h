 ...
 */
#define E0_AUTO_FAN_PIN PF11  // -1 // MNi
...
//
#define ASSISTED_TRAMMING // MNi
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  40, 40 }, { 190,  40 }, { 190, 190 }, { 40, 190 } }

  // Define position names for probe points.
  #define TRAMMING_POINT_NAME_1 "Vorne-Links" // "Front_Left" 
  #define TRAMMING_POINT_NAME_2 "Vorne-Rechts" // "Front-Right"
  #define TRAMMING_POINT_NAME_3 "Hinten-Links" // Rear-Left
  #define TRAMMING_POINT_NAME_4 "Hinten-Rechts" // Rear-Right
  ...
  #define ASSISTED_TRAMMING_WAIT_POSITION { X_CENTER, Y_BED_SIZE, 30 } // Move the nozzle out of the way for adjustment
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #if HAS_BED_PROBE
    #define PROBE_OFFSET_WIZARD // MNi
  ...
  #define PREHEAT_SHORTCUT_MENU_ITEM // MNi war aus ...

#endif // HAS_LCD_MENU

#if ANY(HAS_DISPLAY, DWIN_CREALITY_LCD_ENHANCED, DWIN_CREALITY_LCD_JYERSUI)
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu // MNi
#endif
...
// LCD Print Progress options
  ...
  #define SD_FINISHED_RELEASECOMMAND "M84 X Y Z E"  // Use "M84XYE" to keep Z enabled so your bed stays in pla
  ...
  #define POWER_LOSS_RECOVERY
    ...
    //#define POWER_LOSS_PIN       PA0 // Pin to detect power loss
 ...
 */
#define LIN_ADVANCE // MNi war aus ....
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.0    // Unit: mm compression per 1mm/s extruder speed
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  //#define EXPERIMENTAL_SCURVE // Enable this option to permit S-Curve Acceleration
  #define ALLOW_LOW_EJERK     // Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends. // MNi neuer Wert. War aus.
#endif
...
//
//#define SAVED_POSITIONS 1         // Each saved position slot costs 12 byte
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  (X_CURRENT/2) // GST X_CURRENT  // (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT_HOME  (Y_CURRENT/2) // GST Y_CURRENT
    #define Y_MICROSTEPS     16
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      650 // GST 550 // GST 600
    #define E0_MICROSTEPS    16
